       ...
       <div class="modal">
            ...
            <form class="modal-content animate" action="">
                ...
                <div class="container">
                    ...
                    <input type="text" placeholder="Enter Mobile Number" name="uname" maxlength="10" minlength="10">
...
<option value="Zimbabwe">Zimbabwe</option>
                    ...
                    <button type="submit" onclick="mySignup2()" >Sign up</button>
                    <label>
